      ...
      function syncSubclassInputForClass(entry) {
        ...
        subclassInput.disabled = !names.length;
        if (!names.length) {
          if (classesLoaded) {
            subclassInput.value = "";
          }
      ...
      function renderInventoryItems() {
        ...
        header.innerHTML = showQty
          ? "<span>Name</span><span>Gold</span><span>Qty</span><span>Remove Qty</span><span>Action</span>"
          : "<span>Name</span><span>Gold</span><span>Action</span>";
